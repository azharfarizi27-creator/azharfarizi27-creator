...
<table border="0">
  <tr>
    ...
    <td width="40%" valign="top">
      <h4>⚡ Tech Interests & Focus</h4>
      <ul>
        <li>🔷 C# & .NET Core / ASP.NET</li>
        <li>🗄️ SQL Server & EF Core</li>
        <li>⚛️ React.js & Tailwind CSS</li>
        <li>🏗️ Clean Architecture & Design Patterns</li>
      </ul>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🏪 Aposim — POS & Inventory System</h3>
      <p>Desktop-based Point of Sale & Inventory System built for smooth operational workflow.</p>
      <p>
      ...
      <ul>
        ...
        <li>💰 Sales Transactions & Reporting</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🧠 Interactive Quiz Platform</h3>
      <p>Full-stack educational platform with auto-calculated scoring and live leaderboards.</p>
      <p>
      ...
      <ul>
        <li>⏱️ Timed Quizzes & Auto Evaluation</li>
        <li>🏆 Real-time Leaderboard & Review</li>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>📚 SD-SMA Question API</h3>
      <p>Scalable RESTful API for managing K-12 educational question banks with difficulty filtering.</p>
      <p>
        <img src="https://img.shields.io/badge/ASP.NET%20Web%20API-512BD4?style=flat-square&logo=dotnet&logoColor=white" />
      ...
      <ul>
        <li>🔄 Full CRUD Endpoints & Subject Filtering</li>
        <li>🎯 Multi-tier Difficulty Levels (Easy/Med/Hard)</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🏍️ Wash Queue System</h3>
      <p>Real-time queue management web app optimized for service-based businesses.</p>
      <p>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black" />
        <img src="https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white" />
      </p>
      <ul>
        <li>📋 Queue CRUD & Countdown Timers</li>
        <li>📊 Daily Operations Summary & Stats</li>
      </ul>
    </td>
  </tr>
</table>
